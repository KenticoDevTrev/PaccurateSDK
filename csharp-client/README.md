# IO.Swagger - the C# library for the paccurate.io
...
## Documentation for Models
 ...
 - [Model.Box](docs/Box.md)
 - [Model.BoxProperties](docs/BoxProperties.md)
 - [Model.BoxType](docs/BoxType.md)
 - [Model.BoxTypeSet](docs/BoxTypeSet.md)
 - [Model.Error](docs/Error.md)
 - [Model.Image](docs/Image.md)
 - [Model.Item](docs/Item.md)
 - [Model.ItemProperties](docs/ItemProperties.md)
 - [Model.ItemSet](docs/ItemSet.md)
 - [Model.Pack](docs/Pack.md)
 - [Model.PackResponse](docs/PackResponse.md)
 - [Model.Point](docs/Point.md)
 - [Model.RateTable](docs/RateTable.md)
 - [Model.Rule](docs/Rule.md)
 - [Model.Subspace](docs/Subspace.md)
